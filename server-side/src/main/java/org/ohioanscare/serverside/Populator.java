...
//        Address jeffersonCountryCommunityActionCouncilJeffersonAddress = new Address("114 North Fourth Street", "", "Steubenville", jefferson, "Ohio", z43952, southeast);
//        addressRepo.save(jeffersonCountryCommunityActionCouncilJeffersonAddress);
//        OhioResource jeffersonCountryCommunityActionCouncilJefferson = new OhioResource("Jefferson Country Community Action Council", "Jefferson Country Community Action Council", "The CAC is Continuing A Commitment to restore and revitalize the quality of life in Jefferson County, and move the residents towards self-sufficiency. We achieve this goal by adapting and providing programs that are accessible, affordable, and culturally-sensitive to meet the needs of the community", "", " ", " ", " ", " ", " ", " ", " ", "https://jeffersoncountycac.doodlekit.com/home/housing_programs", "(740) 282-0971", "", jeffersonCountryCommunityActionCouncilJeffersonAddress, housing);
//        ohioResourceRepo.save(jeffersonCountryCommunityActionCouncilJefferson);
